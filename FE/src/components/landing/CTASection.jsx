...
export default function CTASection({ onOpenAuth }) {
  ...
  return (
    <section className="relative py-24 md:py-32 bg-white overflow-hidden" ref={ref}>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl tracking-tighter leading-none text-slate-900 mb-6">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="px-10 py-4 rounded-2xl bg-emerald-600 text-white font-semibold text-lg
