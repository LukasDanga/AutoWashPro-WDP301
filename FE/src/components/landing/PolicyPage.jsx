  ...
  },
  {
    ...
    content: [
      { subtitle: '1. Điều kiện hoàn tiền',
        body: 'Khách hàng được yêu cầu hoàn tiền trong các trường hợp: hủy lịch trước 2 giờ (hoàn 100% cọc), dịch vụ không đạt chất lượng theo cam kết, chi nhánh hủy lịch do lỗi từ phía hệ thống.' },
      { subtitle: '2. Quy trình hoàn tiền',
        body: 'Khách hàng gửi yêu cầu hoàn tiền qua hệ thống. Bộ phận hỗ trợ sẽ xem xét và phản hồi trong vòng 24-48 giờ làm việc. Sau khi được phê duyệt, tiền sẽ được hoàn trong vòng 5-7 ngày làm việc.' },
      { subtitle: '3. Phương thức hoàn tiền',
        body: 'Tiền hoàn được chuyển khoản trực tiếp vào tài khoản ngân hàng của khách hàng hoặc hoàn tiền mặt tại chi nhánh (tùy theo phương thức thanh toán ban đầu).' },
