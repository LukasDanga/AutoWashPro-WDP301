    ...
    <footer className="bg-slate-100 border-t border-slate-200">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div>
            <h4 className="text-emerald-600 text-sm font-semibold mb-4">Dịch vụ</h4>
          ...
          <div>
            <h4 className="text-emerald-600 text-sm font-semibold mb-4">Theo dõi</h4>
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white border border-slate-300 flex items-center justify-center text-slate-600 hover:text-emerald-600 hover:border-emerald-400 transition-colors">
