...
- Mỗi booking PHẢI hiển thị riêng, KHÔNG được gộp các đơn thành 1
- Các fields trong JSON: id, branchName, packageName, licensePlate, bookingDate, startTime, endTime, status, finalPrice, historyUrl
- VÍ DỤ CỤ THỂ - nếu JSON trả về nhiều bookings, phải hiển thị từng block riêng:
...
- **QUAN TRỌNG VỀ LINK**: historyUrl trong JSON đã là URL hoàn chỉnh. Copy nguyên giá trị historyUrl từ JSON vào markdown link. KHÔNG tự viết hay sửa URL khác. If historyUrl = "https://auto-wash-pro-wdp-301.vercel.app/history?bookingId=xyz" thì phải hiển thị [Xem chi tiết](https://auto-wash-pro-wdp-301.vercel.app/history?bookingId=xyz)
